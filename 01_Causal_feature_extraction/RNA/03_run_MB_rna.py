...
# PATHS FOR RNA
FILTERED_DIR = r"C:\Users\olegk\Desktop\Thesis_v3\01_Causal_feature_extraction\RNA\statistical_filtered"
OUTPUT_DIR = r"C:\Users\olegk\Desktop\Thesis_v3\01_Causal_feature_extraction\RNA\mb_results"
...
def process_single_config(dataset_name, rna_df, outcome, algorithm, alpha, pbar, original_features):
    ...
    if len(causal_genes) < MB_MIN_FEATURES:
        _cache = os.path.join(FILTERED_DIR, '..', 'rna_statistics_cache.csv')
...
print("\n" + "="*80)
print("RNA PRODUCTION RUN COMPLETE!")
