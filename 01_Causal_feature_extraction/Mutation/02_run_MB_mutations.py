...
# PATHS FOR MUTATIONS
FILTERED_DIR = r"C:\Users\olegk\Desktop\Thesis_v3\01_Causal_feature_extraction\Mutations\statistical_filtered"
OUTPUT_DIR = r"C:\Users\olegk\Desktop\Thesis_v3\01_Causal_feature_extraction\Mutations\mb_results"
...
print("="*80)
print("MARKOV BLANKET - MUTATIONS")
print("="*80)
...
def process_single_config(dataset_name, rna_df, outcome, algorithm, alpha, pbar, original_features):
    ...
    if len(causal_genes) < MB_MIN_FEATURES:
        _cache = os.path.join(FILTERED_DIR, '..', 'mut_statistics_cache.csv')
...
print("\n" + "="*80)
print("PROCESSING MUTATIONS DATASETS")
print("="*80)
...
print("\n" + "="*80)
print("MUTATIONS PRODUCTION RUN COMPLETE!")
