...
4-modality version: Clinical + RNA + CNV + Mutations only.
"""
...
OUT_DIR   = SCRIPT_DIR / "results_4modalities"
...
DATASET_NAMES = {
    "4modalities_01_ultra_conservative": "4mod-Ultra-Conservative",
    "4modalities_02_conservative":       "4mod-Conservative",
    "4modalities_03_standard":           "4mod-Standard",
    "4modalities_04_fdr_significant":    "4mod-FDR-Significant",
    "4modalities_05_balanced":           "4mod-Balanced",
    "4modalities_06_correlation":        "4mod-Correlation",
    "4modalities_07_top_correlated":     "4mod-Top-Correlated",
    "4modalities_08_composite":          "4mod-Composite",
}
...
if not all_results:
    ...
    results_df.to_csv(OUT_DIR / "mb_results_4modalities.csv", index=False)
    ...
    import json
    with open(OUT_DIR / "best_config_4modalities.json", "w") as f:
        json.dump(best_detail, f, indent=2)
    print(f"\nSaved: best_config_4modalities.json")
    ...
    if skip_mb_log or skip_stb_log:
        ...
        with open(OUT_DIR / "timeout_log_4modalities.txt", "w") as f:
            f.write("MB TIMEOUTS\n" + "\n".join(skip_mb_log))
            f.write("\n\nSTABILITY TIMEOUTS\n" + "\n".join(skip_stb_log))
        print(f"\nSaved: timeout_log_4modalities.txt")
